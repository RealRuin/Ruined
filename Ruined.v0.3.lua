...
local Window = Bracket:Window({Name = "Ruined v0.3",Enabled = true,Color = Color3.new(1,0.5,0.25),Size = UDim2.new(0,496,0,496),Position = UDim2.new(0.5,-248,0.5,-248)}) do
    ...
    local Tab = Window:Tab({Name = "Main",Side = "Left"}) do
        ...
        local Section = Tab:Section({Name = "Player",Side = "Left"}) do
            ...
            Section:Toggle({Name = "Anchor Root Part",Value = false,Callback = function(Toggle_Bool)
                game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = (Toggle_Bool) end}):Keybind({Flag = "Toggle/Keybind",Value = "NONE",DoNotClear = false,Mouse = false,Callback = function(Key_String,Pressed_Bool,Toggle_Bool) end,Blacklist = {"W","A","S","D","Slash","Tab","Backspace","Escape","Space","Delete","Unknown","Backquote"}})
            ...
            end}):Keybind({Flag = "Toggle/Keybind",Value = "NONE",DoNotClear = false,Mouse = false,Callback = function(Key_String,Pressed_Bool,Toggle_Bool) end,Blacklist = {"W","A","S","D","Slash","Tab","Backspace","Escape","Space","Delete","Unknown","Backquote"}})
        ...
        local Section = Tab:Section({Name = "Camera",Side = "Right"}) do
